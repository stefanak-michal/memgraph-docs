...
export default function ConnectToMemgraph() {
    ...
    return (
                <Container size="small" style="padding: 0 0 0 0">
                    <div className={styles.connectToMemgraph}>
                        ...
                        */}
                        ...
                        <section>
                            <h2>Where to next?</h2>
                            <p>
                                To learn more about the <b>Cypher</b> language, visit the <b><a href="https://memgraph.com/docs/cypher-manual/">Cypher manual</a></b> or <b><a href="https://playground.memgraph.com/">Memgraph Playground</a></b> for interactive guides.
